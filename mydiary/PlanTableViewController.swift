...
class PlanTableViewController: UITableViewController {
    ...
    var plandataArray:Array<String>?
    ...
    override func viewDidLoad() {
        ...
        plandataArray = ["plandata1","plandata2","plandata3","plandata4","plandata5"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = plandataArray![indexPath.row]
    ...
    {
        let plandetailView = PlandetailViewController()
